...
@ComponentScan(basePackages = {"com.example.Bank", "com.example.BankController"})
...
public class BankApplication {
	...
	public void initializeAccounts() {
		account1 = new BankAccount(50, 1, "1");
		account2 = new BankAccount(100, 2, "2");
	...
	public static void getAccounts(HashMap<String, BankAccount> accounts) {
